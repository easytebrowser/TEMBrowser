    ...
    return {   	
        ...
        initNewTEs: function () {
        	$.ajax({
    			type : "post",
    			data : {},
    			url : "rest/page/newTEs",
    			success : function(info) {
    				$("#div_new_tes").html(info);    				
    			},
    			error : function() {
        ...
        initNewMailers: function () {
        	$.ajax({
    			type : "post",
    			data : {},
    			url : "rest/page/newMailers",
    			success : function(info) {
    				$("#div_new_mailers").html(info);    				
    			},
    			error : function() {
    				bootbox.alert("Server not available, please try again later.");
    			}
...
function purchase(obj, siteName, price, upline) {
			...
			if(info == 'OK'){
				bootbox.alert({ 
		            ...
		            callback: function() { 
		            	...
		            	$(obj).html('Surfing');
		            	$('#historyCount').val(parseInt($('#historyCount').val()) + 1);
		            },  
